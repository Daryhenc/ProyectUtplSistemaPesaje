...
namespace CADBascula.Producto {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class ProductoDataTable : global::System.Data.TypedTableBase<ProductoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ProductoRow AddProductoRow(string Producto) {
...
namespace CADBascula.Producto.DataSet1TableAdapters {
    ...
    public partial class ProductoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Producto] WHERE (([IdProducto] = @Original_IdProducto) AND ((@" +
                "IsNull_Producto = 1 AND [Producto] IS NULL) OR ([Producto] = @Original_Producto)" +
                "))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Producto] ([Producto]) VALUES (@Producto);\r\nSELECT IdProducto," +
                " Producto FROM Producto WHERE (IdProducto = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Producto] SET [Producto] = @Producto WHERE (([IdProducto] = @Original_IdProducto) AND ((@IsNull_Producto = 1 AND [Producto] IS NULL) OR ([Producto] = @Original_Producto)));
SELECT IdProducto, Producto FROM Producto WHERE (IdProducto = @IdProducto)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT IdProducto, Producto FROM dbo.Producto";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT 0  IdProducto, \'ESCOGER PRODUCTO\' Producto\r\nUNION ALL\r\nSELECT IdProducto, " +
                "Producto \r\nFROM Producto";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "INSERT INTO [dbo].[Producto] ([Producto]) VALUES (@Producto);\r\n";
        ...
        public virtual int FillByCb(DataSet1.ProductoDataTable dataTable) {
        ...
        public virtual DataSet1.ProductoDataTable GetDataByCb() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            DataSet1.ProductoDataTable dataTable = new DataSet1.ProductoDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        ...
        public virtual int Delete(int Original_IdProducto, string Original_Producto) {
        ...
        public virtual int Insert(string Producto) {
            if ((Producto == null)) {
        ...
        public virtual int Update(string Producto, int Original_IdProducto, string Original_Producto, int IdProducto) {
            if ((Producto == null)) {
            ...
            if ((Original_Producto == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[3].Value = ((string)(Original_Producto));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Producto, int Original_IdProducto, string Original_Producto) {
            return this.Update(Producto, Original_IdProducto, Original_Producto, Original_IdProducto);
        }
        ...
        public virtual int InsertProducto(string Producto) {
